---
title: FOR ACTION&#58; New Rural Health Connect system tags in the PMHC MDS
---

The below circular was sent to PHN CEOs on ??? ?? April 2026.
...
#### New Rural Health Connect system tags in the PMHC MDS

##### Overview {#overview-2026x04x??}
...
##### Background {#background-2026x04x??}
...
Weekly or fortnightly reports on volumes of RHC referrals will be provided to 
the Minister for Health. Standard reports in the PMHC MDS will include options 
to filter by these tags to allow PHNs and the department to monitor these referrals.


##### Action required {#action-required-2026x04x??}
...
##### How to apply the tag in the PMHC MDS data entry interface {#attachmenta-2026x04x??}
...
1.	Manual data entry by typing the appropriate tag to the Episode tag field.
    ...
    * The PMHC MDS has been updated to only accept the system tags described at 
      System Tags. Non system tags (i.e. those without a ! at the front) remain free text.
...
##### Considerations for applying the tag in data uploads {#considerations-2026x04x??}

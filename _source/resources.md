...
If you are a service provider, it is recommended that you use the [PDF version](/doc/service-provider-quick-reference-guide-20170920.pdf) produced by
the Department of Health. If you are a Primary Health Network, you can use the [word version](/doc/service-provider-quick-reference-guide-template-20170920.docx) to tailor some of the information to your local context.
